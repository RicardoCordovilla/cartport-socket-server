 ...
 */
async function sendToPinPad(frame: string): Promise<string> {
...
async function logPinPadOperation(logData: any) {
  try {
    const response = await axios.post(process.env.LOG_API_URL || "http://localhost:9000/pinpad", logData);
